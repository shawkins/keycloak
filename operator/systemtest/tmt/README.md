...
Run all plans
```commandline
testing-farm request --compose Fedora-38 --git-url https://github.com/keycloak/keycloak.git
```
...
[.packit.yaml](../../.packit.yaml). Packit can be triggered from the PR by comment, but only members of the keycloak
