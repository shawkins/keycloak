...
https-certificate-file=certfile
----
...
WARNING: The example above includes the database password in plaintext in a common configuration file. Environment variables or an encrypted keystore are preferred for sensitive values.
